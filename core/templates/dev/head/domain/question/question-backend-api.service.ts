...
require('domain/topic/QuestionObjectFactory.ts');
require('domain/topic/QuestionSummaryObjectFactory.ts');
require('domain/question/question-domain.constants.ajs.ts');

angular.module('oppia').factory('QuestionBackendApiService', [
  '$http', 'QuestionSummaryObjectFactory', 'QuestionObjectFactory', '$q',
  'UrlInterpolationService', 'QUESTIONS_LIST_URL_TEMPLATE',
  'QUESTION_PLAYER_URL_TEMPLATE',
  function(
      $http, QuestionSummaryObjectFactory, QuestionObjectFactory,
      $q, UrlInterpolationService,
